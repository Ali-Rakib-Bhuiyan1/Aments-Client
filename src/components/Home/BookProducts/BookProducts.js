...
const BookProducts = () => {
    ...
    const onSubmit = (data) => {
      ...
      data.status = "pending";
      fetch("https://fast-savannah-83899.herokuapp.com/booking", {
        method: "POST",
    ...
    useEffect(() => {
      fetch(`https://fast-savannah-83899.herokuapp.com/products/${productId}`)
        .then((res) => res.json())
    ...
    return (
        ...
        <Grid item xs={4} sm={8} md={6} >
        <Typography  className="text-danger" sx={{textAlign: 'center', m:1, mb:3,  fontWeight:'700'}} variant="h5" component="div">
               Booking Form
            </Typography>
            <form className="form" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input style={{ color:'white' ,backgroundColor:'blue'}} type="submit" className="input" value="Confirm Booking"/>
            </form>
        </Grid>
    </Grid>
    </Container>
